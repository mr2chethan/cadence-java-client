 ...
 * initializer of the instantiated class, the way Java serialization and {@link JsonDataConverter}
 * (through Gson) do. Only a constructor of a superclass runs: {@code Throwable(String)} for
 ...
 *
 * <p>Uses {@code sun.reflect.ReflectionFactory} (module jdk.unsupported), which is reached
 * reflectively because a compile time reference to an internal API fails the build.
 */
